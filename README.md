...
- [DYST](https://github.com/NIoSaT/DYST), 2022-2025: This is an implementation of a so-called history covert channel that allows *covert channel amplification*. The code was implemented by two of my PhD students for one of our TDSC papers.
